...
import { holdTable } from "@/lib/services/admin-match-service";
import { adminHoldTableSchema } from "@/lib/validators/admin";

export async function POST(request: Request): Promise<Response> {
  try {
    const input = adminHoldTableSchema.parse(await request.json());
